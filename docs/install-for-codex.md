...
This will:
- Sync `humanize`, `humanize-gen-plan`, `humanize-plan-check`, `humanize-refine-plan`, and `humanize-rlcr` into `${CODEX_HOME:-~/.codex}/skills`
...
- `${CODEX_HOME:-~/.codex}/skills/humanize-plan-check/SKILL.md`
